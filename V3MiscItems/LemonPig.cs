...
namespace katmod
{
    class LemonPig : PassiveItem
    {
        ...
        public static void InitProjectile()
        {
            ...
            {
                initCoin.AnimateProjectile(spriteIds, 24, true, intVectors, dontEvenKnowWhatThisIs, anchors, changesColliders, fixesScale, vector2dotZero, offsets, offsets, WhenSpAPIInevitablySeesThisAndCallsItBadCodeLetItBeKnownIHadAbsolutelyNoIdeaOnWhatToPutHere);

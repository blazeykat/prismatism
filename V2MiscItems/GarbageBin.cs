...
namespace katmod
{
	class GarbageBin : PlayerItem
	{
		...
		protected override void DoEffect(PlayerController user)
		{
            ...
            {
				if (BoxOTools.BasicRandom(0.975f) && !base.LastOwner.HasPickupID(580) && !base.LastOwner.HasPickupID(641))
				{
					if (BoxOTools.BasicRandom(0.05f) && base.LastOwner.HasPickupID(580))
					{

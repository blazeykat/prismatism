...
namespace katmod
{
	...
	internal class ToxicHoneycomb : PassiveItem
	{
		...
		private void OnPlayerHit(PlayerController player)
		{
			...
			{
				Projectile maidenProjectile = base.Owner.HandleProjectile(9, 5, 14, false, true, ((player.PlayerHasActiveSynergy("bzzzzzzzzzzzzzzz") ? 22.5f : 45) * counter), 300);
				...
				{
					Projectile component = player.HandleProjectile(20f, 12f, 207, false, true, UnityEngine.Random.Range(0.0f, 360.0f), 500);

...
namespace katmod
{
    class WyrmBlood : PassiveItem
    {
        public static void Init()
        {
            ...
            string resourcePath = "katmod/Resources/WyrmSet/wyrmspoision.png";
            ...
            item.SetupUnlockOnStat(TrackedStats.TIMES_CLEARED_FORGE, DungeonPrerequisite.PrerequisiteOperation.GREATER_THAN, 14);

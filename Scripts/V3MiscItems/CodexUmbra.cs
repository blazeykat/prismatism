...
namespace katmod
{
    class CodexUmbra : PassiveItem
    {
        public static void Init()
        {
            ...
            string longd = "Conjure the shadows to your will, duplicating most pick-ups.";
        ...
        public static void GiveRandomItem(PlayerController player)
        {
            switch ((int)UnityEngine.Random.Range(1, 11))
            {
                ...
                case 6:
                case 7:
                    LootEngine.SpawnCurrency(player.specRigidbody.UnitCenter, 10, false);
                    break;
                case 8:

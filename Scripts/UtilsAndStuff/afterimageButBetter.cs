...
namespace katmod
{
    public class afterimageButBetter : BraveBehaviour
    {

        public afterimageButBetter()
        {
            shaders = new List<Shader>();
            shaders.Add(ShaderCache.Acquire("Brave/Internal/RainbowChestShader"));
            shaders.Add(ShaderCache.Acquire("Brave/Internal/GlitterPassAdditive"));
            shaders.Add(ShaderCache.Acquire("Brave/Internal/HologramShader"));
            shaders.Add(ShaderCache.Acquire("Brave/Internal/HighPriestAfterImage"));
        ...
        public void LateUpdate()
        {
            ...
            LinkedListNode<afterimageButBetter.Shadow> next;
            for (LinkedListNode<afterimageButBetter.Shadow> linkedListNode = this.m_activeShadows.First; linkedListNode != null; linkedListNode = next)
            {
        ...
        private IEnumerator HandleDeathShadowCleanup()
        {
            ...
            {
                LinkedListNode<afterimageButBetter.Shadow> next;
                for (LinkedListNode<afterimageButBetter.Shadow> node = this.m_activeShadows.First; node != null; node = next)
                {
                    next = node.Next;
        ...
        private void SpawnNewShadow()
        {
            ...
            LinkedListNode<afterimageButBetter.Shadow> first = this.m_inactiveShadows.First;
        ...
        private void CreateInactiveShadow()
        {
            ...
            this.m_inactiveShadows.AddLast(new afterimageButBetter.Shadow
            {
        ...
        private readonly LinkedList<afterimageButBetter.Shadow> m_activeShadows;

        private readonly LinkedList<afterimageButBetter.Shadow> m_inactiveShadows;

...
namespace ItemAPI
{
    ...
    class AdvancedGameStatsManager
    {
        ...
        public static void DoMidgameSave()
        {
            ...
            SaveManager.Save(obj, DaveAPIManager.AdvancedMidGameSave, GameStatsManager.Instance.PlaytimeMin, 0u, null);
        ...
        {
            if (!SaveManager.Load(DaveAPIManager.AdvancedGameSave, out midgameSave, true, 0u, null, null))
            {
        ...
        public static bool Save()
        {
            ...
            try
            {
                result = SaveManager.Save<AdvancedGameStatsManager>(m_instance, DaveAPIManager.AdvancedGameSave, GameStatsManager.Instance.PlaytimeMin, 0u, null);
            }
            catch (Exception ex)
            {
